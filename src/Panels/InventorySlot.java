...
public class InventorySlot extends JPanel {
	...
	private Image NotEnabledImage = MainApplet
			.getImage("items/back2_cross.jpg");
	...
	class mLis extends MouseAdapter {
		public void mousePressed(MouseEvent e) {
			if (e.getButton() == MouseEvent.BUTTON1) {
				...
				*/
				...
				if (!isDoubleClick) {
					...
					System.out.println("Clicked ; trading : "+MainApplet.getGamePanel().tradeScreen().isTrading());
			...
			if (e.getButton() == MouseEvent.BUTTON3) {
				MainApplet.addInfo(item.getExamineText());
			}
		...
		public void mouseEntered(MouseEvent e) {
			if (!item.getName().equals("")) {
				...
				MainApplet.setFlyingInfo(title + " / " + option2);
			}
		}
	...
	class mmLis extends MouseMotionAdapter {
		public void mouseMoved(MouseEvent e) {
			MainApplet.getGamePanel().invScreen().setLocationOfCursor(e.getX(),
					e.getY(), getID());
		}
	}
