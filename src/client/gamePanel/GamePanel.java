...
import client.App;
import client.CustomPanel;
import client.ShopPanel;
import client.panels.ChatPanel;
import client.panels.InfoPanel;
import client.panels.InventoryEquipPanel;
import client.panels.InventoryPanel;
import client.panels.OptionPanel;
import client.trade.TradeInvitation;
import client.trade.TradePanel;
...
public class GamePanel extends CustomPanel {
	...
	public GamePanel() {
		...
		invScreen = new InventoryPanel(App.actPlayer.getInventoryManager());
		equipScreen = new InventoryEquipPanel(App.actPlayer.getInventoryManager());
