...
public class TradePanel extends CustomPanel {
	...
	public TradePanel () {
		this.manager = App.actPlayer.getInventoryManager();
	...
	public void setVisible (boolean bool, String name) {
		...
		if (name.equals("a player"))
			name = App.getGamePanel().invitScreen().getName();
		
		label.setText(lbTxt+name);
	}
	public void setVisible(boolean bool) {
		super.setVisible(bool);
		App.actPlayer.setInAction(bool);
		isTrading = bool;
		
		try {
			App.getGamePanel().menuPanel().setFixShowing(bool);
