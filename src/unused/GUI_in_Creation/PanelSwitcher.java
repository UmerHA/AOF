...
public class PanelSwitcher extends JPanel {
	...
	private TextPanel[] txtPanel = new TextPanel[5];
	...
	public boolean addPanel (JPanel panel, String name) {
		//There may only be up to 5 panels, so :
		if (panelAmount == 5)
			return false;
	...
	public static void main (String[] args) {
		...
		TestPanel a = new TestPanel(1);
		TestPanel b = new TestPanel(2);
		TestPanel c = new TestPanel(3);
		TestPanel d = new TestPanel(1);
		TestPanel e = new TestPanel(2);
		
		PanelSwitcher ps = new PanelSwitcher();
		ps.addPanel(a, "Stats");
		ps.addPanel(b, "Inventory");
		ps.addPanel(c, "Equipment");
		ps.addPanel(d, "Quests");
		ps.addPanel(e, "Spellbook");
